...
export default function ExtractPagesTool({ onClose }: ExtractPagesToolProps) {
  ...
  const handleFileChange = async (files: File[]) => {
    ...
    try {
      // 1. Read PDF details via pdf-lib
      ...
      // 2. Load PDF.js details for page thumbnail previews
  ...
  const handleRangeInputChange = (value: string) => {
    ...
    try {
      ...
      // parsePageRanges returns 1-based page indices, convert to 0-based for Set matching
      const zeroBased = parsedIndices.map(p => p - 1);
  ...
  const validateAndSyncRangeInput = () => {
    ...
    try {
      ...
      setRangeInput(generateRangeString(zeroBased));
      setValidationError(null);
    } catch (err: any) {
              ...
              <div className="bg-slate-50/50 dark:bg-slate-950/20 p-4 border border-slate-150 dark:border-slate-800/60 rounded-2xl space-y-4">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[10px] text-slate-455 dark:text-slate-550 font-semibold">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center px-1">
                  <h4 className="text-xs font-extrabold text-navy dark:text-white uppercase tracking-wider flex items-center gap-1.5">
                    ...
                    <span>Interactive Page Workspace Grid</span>
                  </h4>
